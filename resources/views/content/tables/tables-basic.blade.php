...
@section('title', 'Projects - Basic Projects')

@section('content')
  <h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Projects /</span> Basic Projects
  </h4>
  ...
  {{-- <div class="card">
    ...
    <table class="table">
      ...
      <tr>
        <td><i class="bx bxl-bootstrap bx-sm text-primary me-3"></i> <span class="fw-medium">Bootstrap Project</span>
        </td>
        <td>Jerry Milton</td>
        <td>
        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
  ...
  {{-- <div class="card">
    ...
    <div class="table-responsive text-nowrap">
      ...
      <tbody>
        <tr>
        <td><i class="bx bxl-angular bx-sm text-danger me-3"></i> <span class="fw-medium">Angular Project</span>
        </td>
        <td>Albert Cook</td>
        <td>
          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
  ...
  <div class="demo-inline-spacing mb-4">
    <button type="button" class="btn btn-primary" onclick="window.location.href='/form/layouts-vertical'">
    <i class='bx bxs-comment-add'></i>add a new project
    </button>
  </div>
  <div class="card">
    <div class="table-responsive text-nowrap">
    <table class="table table-hover">
      ...
      <tbody class="table-border-bottom-0">
      <tr>
        <td> <span class="fw-medium">logistics</span></td>
        <td>Mohamed helmy</td>
        <td>
        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
          <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
      ...
      <tr>
        <td><span class="fw-medium">green globe</span></td>
        <td>mohamed helmy</td>
        <td>
        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
          <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
      ...
      <tr>
        <td><span class="fw-medium">Zaitoun</span></td>
        <td>Mohamed helmy</td>
        <td>
        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
          <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
  ...
  {{-- <div class="card">
    ...
    <table class="table">
      ...
      <tr class="table-info">
        <td><i class="bx bxl-bootstrap bx-sm text-primary me-3"></i> <span class="fw-medium">Latest Bootstrap</span>
        </td>
        <td>Perry Parker</td>
        <td>
        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
