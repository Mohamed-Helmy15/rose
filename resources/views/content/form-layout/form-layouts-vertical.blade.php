...
@section('content')
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Projects/</span> Add a new project</h4>
  ...
  <div class="row">
    ...
    <div class="card mb-4">
      ...
      <form>
        ...
        <input type="text" class="form-control" id="basic-default-fullname" placeholder="logistics" />
        </div>
        <div class="mb-3">
        <label class="form-label" for="basic-default-company">Company</label>
        <input type="text" class="form-control" id="basic-default-company" placeholder="Zaitoun" />
        </div>
        <div class="mb-3">
        ...
        <textarea id="basic-default-message" class="form-control" placeholder="leave your message"></textarea>
        </div>
