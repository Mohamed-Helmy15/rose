...
@section('content')
  <div class="row">
    ...
    <div class="card">
      ...
      <div class="col-sm-7">
        <div class="card-body">
        <h5 class="card-title text-primary">{{ __('about.welcome') }} helmy 🎉</h5>
        <p class="mb-4">You have done <span class="fw-medium">60%</span> more sales today</p>
    ...
    <div class="row">
      ...
      <div class="card">
        ...
        <h3 class="card-title mb-2">$88</h3>
        <small class="text-success fw-semibold"><i class='bx bx-up-arrow-alt'></i> +50%</small>
        </div>
      </div>
      </div>
      <div class="col-lg-6 col-md-12 col-6 mb-4">
      <div class="card">
        ...
        <small class="text-success fw-medium"><i class='bx bx-up-arrow-alt'></i> +30.6%</small>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="col-md-8">
        <h5 class="card-header m-0 me-2 pb-3">Total</h5>
      ...
      <div class="col-md-4">
        ...
        <div class="text-center fw-medium pt-3 mb-2">30% Company Growth</div>
