...
<html dir="rtl" lang="ar"
    class="desktop win chrome chrome141 webkit oc30 is-customer route-account-wishlist store-0 skin-1 desktop-header-active mobile-sticky layout-6 one-column column-right"
...
<body class="">
    ...
    <div class="site-wrapper">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#?route=account/wishlist">قائمة رغباتي</a></li>
        </ul>

        <div id="account-wishlist" class="container">
            <div class="row">
                <div id="content" class="col-sm-9">
                    <h1 class="title page-title">قائمة رغباتي</h1>
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-left td-name">اسم المنتج</td>
                                    <td class="text-center td-model">النوع</td>
                                    <td class="text-center td-stock">حالة التوفر</td>
                                    <td class="text-center td-price">سعر الوحدة</td>
                                    <td class="text-center td-action">تحرير</td>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="">
                                    <td class="text-center td-image"><a
                                            href="#?route=product/product&amp;product_id=212"><img
                                                src="https://rosehills.sa/image/cache/catalog/images/products/Copy%20of%20Store%20ballon%20%20and%20mather%20day%2015-90x90.jpg"
                                    ...
                                    <td class="text-center td-stock in-stock">متوفر</td>
                                    <td class="text-center td-price">
                                        <div class="price"> 5 ر.س
                                        </div>
                                    </td>
                                    <td class="text-center td-action">
                                        <button type="button" onclick="cart.add('212');" data-toggle="tooltip"
                                            title="اضافة للسلة" class="btn btn-primary"
                                            data-loading-text="<i class='fa fa-shopping-cart'></i>"><i
                                                class="fa fa-shopping-cart"></i></button>
                                        <a href="#?route=account/wishlist&amp;remove=212"
                                            data-toggle="tooltip" title="حذف" class="btn btn-danger btn-remove"><i
                    ...
                    <div class="buttons clearfix">
                        <div class="pull-right"><a href="#?route=account/account"
                                class="btn btn-primary">متابعة</a></div>
                    </div>
                </div>
                                                    ...
                                                    <li class="menu-item accordion-menu-item accordion-menu-item-11 ">
                                                        <a>
                                                            ...
                                                            <span class="open-menu collapsed" data-toggle="collapse"
                                                                data-target="#collapse-690110072d1cf"
                                                                role="heading"><i class="fa fa-plus"></i></span>
                                                        </a>
                                                        <div class="collapse " id="collapse-690110072d1cf">
                                                            <ul class="j-menu">
