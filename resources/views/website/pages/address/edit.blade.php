...
<body class="">
    ...
    <div class="site-wrapper">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#?route=account/address/edit&amp;address_id=93">تحرير العناوين</a>
            </li>
        </ul>
        ...
        <div id="account-address" class="container">
            <div class="row">
                <div id="content" class="col-sm-9">
                    <h1 class="title page-title">تحرير العناوين</h1>

                    <form action="#?route=account/address/edit&amp;address_id=93"
                        ...
                        <div id="address">
                            <div class="form-group required address-firstname">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="firstname" value="mohamed" placeholder="الاسم الاول"
                                        id="input-firstname" class="form-control">
                                </div>
                            </div>
                            <div class="form-group  address-lastname">
                            ...
                            <div class="form-group  address-company">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="company" value="" placeholder="الشركة"
                                        id="input-company" class="form-control">
                                </div>
                            </div>
                            <div class="form-group required address-address-1">
                                <label class="col-sm-2 control-label" for="input-address-1">العنوان الاول</label>
                                <div class="col-sm-10">
                                    <input type="text" name="address_1" value="ddsdfs" placeholder="العنوان الاول"
                                        id="input-address-1" class="form-control">
                                </div>
                            </div>
                            <div class="form-group  address-address-2">
                                <label class="col-sm-2 control-label" for="input-address-2">العنوان الثاني</label>
                                <div class="col-sm-10">
                                    <input type="text" name="address_2" value="" placeholder="العنوان الثاني"
                            ...
                            <div class="form-group required address-city">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="city" value="el mahallah el kobra"
                                        placeholder="المدينة" id="input-city" class="form-control">
                                </div>
                            </div>
                            <div class="form-group address-postcode">
                                <label class="col-sm-2 control-label" for="input-postcode">صندوق البريد</label>
                                <div class="col-sm-10">
                                    <input type="text" name="postcode" value="" placeholder="صندوق البريد"
                                        id="input-postcode" class="form-control">
                                </div>
                            </div>
                            <div class="form-group  address-country">
                                <label class="col-sm-2 control-label" for="input-country">البلد</label>
                                <div class="col-sm-10">
                                    <select name="country_id" id="input-country" class="form-control">
                                        <option value=""> --- الرجاء الاختيار --- </option>


                                        <option value="184" selected="selected">السعودية</option>
                            ...
                            <div class="form-group required address-zone">
                                <label class="col-sm-2 control-label" for="input-zone">المنطقة / المحافظة</label>
                                <div class="col-sm-10">
                                    <select name="zone_id" id="input-zone" class="form-control">
                                        <option value=""> --- الرجاء الاختيار --- </option>
                                        <option value="2879" selected="selected">الرياض</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">العنوان الافتراضي</label>
                        ...
                        <div class="buttons clearfix">
                            <div class="pull-left"><a href="#?route=account/address"
                                    class="btn btn-default">رجوع</a></div>
                            <div class="pull-right">
                                <button type="submit" class="btn btn-primary"><span>متابعة</span></button>
                            </div>
                        </div>
                    </form>
                </div>
                                                    ...
                                                    <li class="menu-item accordion-menu-item accordion-menu-item-11 ">
                                                        <a>
                                                            ...
                                                            <span class="open-menu collapsed" data-toggle="collapse"
                                                                data-target="#collapse-6901a39168d4e"
                                                                role="heading"><i class="fa fa-plus"></i></span>
                                                        </a>
                                                        <div class="collapse " id="collapse-6901a39168d4e">
                                                            <ul class="j-menu">
