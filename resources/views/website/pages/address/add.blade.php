...
<body class="">
    ...
    <div class="site-wrapper">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#?route=account/address/add">إضافة عنوان جديد</a></li>
        </ul>

        <div id="account-address" class="container">
            <div class="row">
                <div id="content" class="col-sm-9">
                    <h1 class="title page-title">إضافة عنوان جديد</h1>
                    ...
                    <form action="#?route=account/address/add" method="post"
                        ...
                        <div id="address">
                            ...
                            <div class="form-group required address-address-1">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="address_1" value="" placeholder="العنوان الاول"
                            ...
                            <div class="form-group required address-city">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="city" value="" placeholder="المدينة"
                            ...
                            <div class="form-group required address-zone">
                                ...
                                <div class="col-sm-10">
                                    <select name="zone_id" id="input-zone" class="form-control">
                                        <option value=""> --- الرجاء الاختيار --- </option>
                                        <option value="2879">الرياض</option>
                                    </select>
                                </div>
                            </div>
                                                    ...
                                                    <li class="menu-item accordion-menu-item accordion-menu-item-11 ">
                                                        <a>
                                                            ...
                                                            <span class="open-menu collapsed" data-toggle="collapse"
                                                                data-target="#collapse-6901a168a258e"
                                                                role="heading"><i class="fa fa-plus"></i></span>
                                                        </a>
                                                        <div class="collapse " id="collapse-6901a168a258e">
                                                            <ul class="j-menu">
