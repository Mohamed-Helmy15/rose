...
<div class="container-fluid animate__animated animate__fadeIn">
    ...
    <div class="card animate__animated animate__zoomIn">
        <h5 class="card-header bg-primary text-white py-4">
            تعديل المخزن: <strong>{{ $warehouse->name }}</strong>
        </h5>

        <div class="card-body p-5">
            <form action="{{ route('inventory.update', $warehouse) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mt-5 d-flex gap-3 justify-content-end">
                    <button type="submit" class="btn btn-primary btn-lg px-5 animate__animated animate__pulse">
                        <i class='bx bx-check'></i> تحديث المخزن
                    </button>
