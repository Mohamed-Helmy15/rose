            ...
            <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-center mb-5">
                    <div class="d-flex flex-wrap justify-content-center" id="currentImages">
                        @foreach($product->images as $image)
                            <div class="position-relative" style="margin: 8px;">
                                <img src="{{ asset('storage/' . $image->image_path) }}" class="image-preview" alt="صورة">
                    ...
                    <div class="drop-zone mt-4" id="dropZone">
                        ...
                        <p class="mt-3 fw-bold">إضافة صور جديدة (متعدد)</p>
                    ...
                    <div class="col-md-6 animate__animated animate__fadeInRight">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <input type="color" class="form-control form-control-color" name="color"
                                   value="{{ old('color', $product->color) }}" style="width:100px;height:60px;">
