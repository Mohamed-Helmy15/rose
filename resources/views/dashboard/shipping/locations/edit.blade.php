{{-- resources/views/dashboard/shipping/locations/edit.blade.php --}}
@extends('layouts/contentNavbarLayout')

@section('title', 'تعديل {{ $location->name }} - زهور')
...
<div class="container-fluid animate__animated animate__fadeIn">
    <h4 class="py-3 mb-4 animate__animated animate__fadeInDown">
        <span class="text-muted fw-light">الشحن / الأماكن /</span> تعديل مكان
    </h4>

    <div class="card animate__animated animate__zoomIn">
        <h5 class="card-header">تعديل المكان</h5>
        <div class="card-body">
            <form action="{{ route('shipping.locations.update', $location) }}" method="POST">
                @csrf @method('PUT')
                <div class="row">
