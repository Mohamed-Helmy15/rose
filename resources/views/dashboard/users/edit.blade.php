...
@section('title', 'تعديل مستخدم - زهور')
...
@section('content')
    <div class="container-fluid animate__animated animate__fadeIn">
        <h4 class="py-3 mb-4 animate__animated animate__fadeInDown">
            <span class="text-muted fw-light">المستخدمين /</span> تعديل مستخدم
        </h4>
            ...
            <div class="card-body">
                <form action="{{ route('users.update', $user) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3 animate__animated animate__fadeInRight">
                            <label class="form-label">كلمة المرور (اترك فارغًا إذا لم ترغب في التغيير)</label>
